...
*/
void LIBNOVA_EXPORT ln_get_parallax(const struct ln_equ_posn *object,
	double au_distance, const struct ln_lnlat_posn *observer, double height,
...
* \brief Calculate parallax in RA and DEC for given geographic location
*/
void LIBNOVA_EXPORT ln_get_parallax_ha(const struct ln_equ_posn *object,
	double au_distance, const struct ln_lnlat_posn *observer, double height,
