...
* \ingroup angular
*/		
double LIBNOVA_EXPORT ln_get_angular_separation(const struct ln_equ_posn *posn1,
...
* \ingroup angular
*/	
double LIBNOVA_EXPORT ln_get_rel_posn_angle(const struct ln_equ_posn *posn1,
	const struct ln_equ_posn *posn2);
