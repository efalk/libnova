...
* \ingroup rst
*/
int LIBNOVA_EXPORT ln_get_object_rst(double JD, const struct ln_lnlat_posn *observer, const struct ln_equ_posn *object, struct ln_rst_time *rst);
...
*
*/
int LIBNOVA_EXPORT ln_get_object_rst_horizon(double JD, const struct ln_lnlat_posn *observer,
    const struct ln_equ_posn *object, long double horizon, struct ln_rst_time *rst);

int LIBNOVA_EXPORT ln_get_object_rst_horizon_offset(double JD, const struct ln_lnlat_posn *observer,
    const struct ln_equ_posn *object, long double horizon, struct ln_rst_time *rst, double ut_offset);
...
* \ingroup rst
*/
int LIBNOVA_EXPORT ln_get_object_next_rst(double JD, const struct ln_lnlat_posn *observer, const struct ln_equ_posn *object, struct ln_rst_time *rst);
...
* \ingroup rst
*/
int LIBNOVA_EXPORT ln_get_object_next_rst_horizon(double JD, const struct ln_lnlat_posn *observer, const struct ln_equ_posn *object,
 ...
 * \ingroup rst
 */
int LIBNOVA_EXPORT ln_get_body_rst_horizon(double JD, const struct ln_lnlat_posn *observer, void (*get_equ_body_coords)(double, struct ln_equ_posn *), double horizon, struct ln_rst_time *rst);

int LIBNOVA_EXPORT ln_get_body_rst_horizon_offset(double JD, const struct ln_lnlat_posn *observer, void (*get_equ_body_coords)(double, struct ln_equ_posn *), double horizon, struct ln_rst_time *rst, double ut_offset);
 ...
 * \ingroup rst
 */
int LIBNOVA_EXPORT ln_get_body_next_rst_horizon(double JD, const struct ln_lnlat_posn *observer, void (*get_equ_body_coords)(double, struct ln_equ_posn *), double horizon, struct ln_rst_time *rst);
 ...
 * \ingroup rst
 */
int LIBNOVA_EXPORT ln_get_body_next_rst_horizon_future(double JD, const struct ln_lnlat_posn *observer, void (*get_equ_body_coords)(double, struct ln_equ_posn *), double horizon, int day_limit, struct ln_rst_time *rst);
 ...
 * \ingroup rst
 */
int LIBNOVA_EXPORT ln_get_motion_body_rst_horizon(double JD, const struct ln_lnlat_posn *observer, get_motion_body_coords_t get_motion_body_coords, void * orbit, double horizon, struct ln_rst_time *rst);

int LIBNOVA_EXPORT ln_get_motion_body_rst_horizon_offset(double JD, const struct ln_lnlat_posn *observer, get_motion_body_coords_t get_motion_body_coords, void * orbit, double horizon, struct ln_rst_time *rst, double offset);
 ...
 * \ingroup rst
 */
int LIBNOVA_EXPORT ln_get_motion_body_next_rst_horizon(double JD, const struct ln_lnlat_posn *observer, get_motion_body_coords_t get_motion_body_coords, void * orbit, double horizon, struct ln_rst_time *rst);
 ...
 * \ingroup rst
 */
int LIBNOVA_EXPORT ln_get_motion_body_next_rst_horizon_future(double JD, const struct ln_lnlat_posn *observer, get_motion_body_coords_t get_motion_body_coords, void * orbit, double horizon, int day_limit, struct ln_rst_time *rst);
